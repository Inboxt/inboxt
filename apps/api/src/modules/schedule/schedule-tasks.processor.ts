...
import { EMAIL_ACCOUNT_DELETED, EMAIL_VERIFY_REMINDER } from '~common/constants/email.constants';
...
export class ScheduleTasksProcessor extends BaseQueueProcessor {
	...
	private async deleteUnverifiedUsers() {
		...
		if (!requireVerification) {
			this.logger.log(
				'Skipping deletion of unverified users as REQUIRE_EMAIL_VERIFICATION is false.',
			);
			return;
		}
