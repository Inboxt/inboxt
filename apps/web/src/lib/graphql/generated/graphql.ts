...
export type HighlightFragmentFragment = { __typename?: 'Highlight', id: string, createdAt: string, savedItem?: { __typename?: 'SavedItem', id: string, title: string, createdAt: string } | null, segments?: Array<{ __typename?: 'HighlightSegment', id: string, xpath: string, beforeText: string, startOffset: number, endOffset: number, afterText: string, text?: string | null }> | null };

type EntryFragment_Highlight_Fragment = { __typename: 'Highlight', id: string, createdAt: string, savedItem?: { __typename?: 'SavedItem', id: string, title: string, createdAt: string } | null, segments?: Array<{ __typename?: 'HighlightSegment', id: string, xpath: string, beforeText: string, startOffset: number, endOffset: number, afterText: string, text?: string | null }> | null };
...
export type EntriesQuery = { __typename?: 'Query', entries: { __typename?: 'EntryConnection', edges: Array<{ __typename?: 'EntryEdge', cursor: string, node:
        | { __typename: 'Highlight', id: string, createdAt: string, savedItem?: { __typename?: 'SavedItem', id: string, title: string, createdAt: string } | null, segments?: Array<{ __typename?: 'HighlightSegment', id: string, xpath: string, beforeText: string, startOffset: number, endOffset: number, afterText: string, text?: string | null }> | null }
        | { __typename: 'SavedItem', id: string, createdAt: string, title: string, originalUrl?: string | null, sourceDomain?: string | null, description?: string | null, leadImage?: string | null, wordCount: number, author?: string | null, type: SavedItemType, status: SavedItemStatus, readingProgress?: number | null, readAt?: string | null, isReadManual: boolean, labels?: Array<{ __typename?: 'Label', createdAt: string, id: string, name: string, color: string }> | null }
