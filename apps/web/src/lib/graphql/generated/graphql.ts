...
export type UserFragmentFragment = { __typename?: 'User', id: string, createdAt: string, emailAddress: string, isEmailVerified: boolean, username: string, pendingEmailAddress?: string | null, plan: UserPlan, labelsCount: number, inboundEmailAddressesCount: number, lastExportAt?: string | null };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, createdAt: string, emailAddress: string, isEmailVerified: boolean, username: string, pendingEmailAddress?: string | null, plan: UserPlan, labelsCount: number, inboundEmailAddressesCount: number, lastExportAt?: string | null } | null };
...
export type UpdateAccountMutation = { __typename?: 'Mutation', updateAccount: { __typename?: 'User', id: string, createdAt: string, emailAddress: string, isEmailVerified: boolean, username: string, pendingEmailAddress?: string | null, plan: UserPlan, labelsCount: number, inboundEmailAddressesCount: number, lastExportAt?: string | null } };
