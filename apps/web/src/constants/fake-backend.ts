...
export const ARTICLE_FROM_BACKEND = {
	id: '3706e586-f4b8-46d4-bd2a-f7e4f9bc520b',
...
export const MARKDOWN_ARTICLE_FROM_BACKEND = {
	title: 'Rubber duck debugging',
	content:
		'In [software engineering](https://en.m.wikipedia.org/wiki/Software_engineering), **rubber duck debugging** (or **rubberducking**) is a method of [debugging](https://en.m.wikipedia.org/wiki/Debugging) code by articulating a problem in spoken or written [natural language](https://en.m.wikipedia.org/wiki/Natural_language). The name is a reference to a story in the book _[The Pragmatic Programmer](https://en.m.wikipedia.org/wiki/The_Pragmatic_Programmer)_ in which a programmer would carry around a [rubber duck](https://en.m.wikipedia.org/wiki/Rubber_duck) and debug their code by forcing themselves to explain it, line by line, to the duck.[\\[1\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-pragprog-1) Many other terms exist for this technique, often involving different (usually) inanimate objects, or pets such as a dog or a cat. [Teddy bears](https://en.m.wikipedia.org/wiki/Teddy_bears) are also widely used.[\\[2\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-2)\n\n[![](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Rubber_duck_assisting_with_debugging.jpg/220px-Rubber_duck_assisting_with_debugging.jpg)](https://en.m.wikipedia.org/wiki/File:Rubber_duck_assisting_with_debugging.jpg)\n\nA [rubber duck](https://en.m.wikipedia.org/wiki/Rubber_duck) in use by a developer to aid debugging\n\nMany programmers have had the experience of explaining a problem to someone else, possibly even to someone who knows nothing about programming, and then hitting upon the solution in the process of explaining the problem. In describing what the code is supposed to do and observing what it actually does, any incongruity between these two becomes apparent.[\\[3\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-cardboarddog-3) More generally, teaching a subject forces its evaluation from different perspectives and [can provide a deeper understanding](https://en.m.wikipedia.org/wiki/Learning_by_teaching).[\\[4\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-4) By using an inanimate object, the programmer can try to accomplish this without having to interrupt anyone else, and with better results than have been observed from merely thinking aloud without an audience.[\\[5\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-5) This approach has been taught in [computer science](https://en.m.wikipedia.org/wiki/Computer_science) and software engineering courses.[\\[6\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-6)[\\[7\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-7)\n\nOn 1 April 2018, [Stack Exchange](https://en.m.wikipedia.org/wiki/Stack_Exchange) introduced a rubber duck avatar on their websites as a new "feature" called _Quack Overflow_ as an [April Fools\' Day](https://en.m.wikipedia.org/wiki/April_Fools%27_Day) joke. The duck appeared at the bottom right corner of the browser [viewport](https://en.m.wikipedia.org/wiki/Viewport), and attempted to help visitors by listening to their problems and responding with solutions. However, the duck merely produced a [quack](https://en.m.wikipedia.org/wiki/Quack_\\(sound\\)) sound after apparently thinking and typing. It referenced _rubber ducking_ as a powerful method for solving problems.[\\[8\\]](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_note-8)\n\n*    [](https://en.m.wikipedia.org/wiki/File:Octicons-terminal.svg)[Computer programming portal](https://en.m.wikipedia.org/wiki/Portal:Computer_programming)\n\n*   [Code review](https://en.m.wikipedia.org/wiki/Code_review)\n*   [Pair programming](https://en.m.wikipedia.org/wiki/Pair_programming)\n*   [Socratic method](https://en.m.wikipedia.org/wiki/Socratic_method)\n*   [Desk checking](https://en.m.wikipedia.org/wiki/Desk_checking)\n*   [Duck test](https://en.m.wikipedia.org/wiki/Duck_test)\n*   [Duck typing](https://en.m.wikipedia.org/wiki/Duck_typing)\n*   [Software walkthrough](https://en.m.wikipedia.org/wiki/Software_walkthrough)\n*   [Eureka effect § The Aha! effect and scientific discovery](https://en.m.wikipedia.org/wiki/Eureka_effect#The_Aha!_effect_and_scientific_discovery)\n*   [Think aloud protocol](https://en.m.wikipedia.org/wiki/Think_aloud_protocol)\n*   [Pointing and calling](https://en.m.wikipedia.org/wiki/Pointing_and_calling)\n*   [Rogerian method](https://en.m.wikipedia.org/wiki/Rogerian_method)\n*   [Worry dolls](https://en.m.wikipedia.org/wiki/Worry_dolls)\n*   [Learning by teaching](https://en.m.wikipedia.org/wiki/Learning_by_teaching)\n*   [Body doubling](https://en.m.wikipedia.org/wiki/Body_doubling)\n\n1.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-pragprog_1-0)** Hunt, Andrew; Thomas, David (1999). [_The Pragmatic Programmer: From Journeyman to Master_](https://archive.org/details/isbn_9780201616224). Addison Wesley. [ISBN](https://en.m.wikipedia.org/wiki/ISBN_\\(identifier\\)) [978-0201616224](https://en.m.wikipedia.org/wiki/Special:BookSources/978-0201616224). p. 95, footnote.\n2.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-2)** Debugging, Rubber Duck. ["Rubber Duck Debugging"](https://rubberduckdebugging.com/). _rubberduckdebugging.com_. [Archived](https://web.archive.org/web/20201112022638/http://rubberduckdebugging.com/) from the original on 12 November 2020. Retrieved 14 September 2023.\n3.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-cardboarddog_3-0)** Baker, SJ, [_The Contribution of the Cardboard Cutout Dog to Software Reliability and Maintainability_](http://www.sjbaker.org/humor/cardboard_dog.html), [archived](https://web.archive.org/web/20131005123545/http://www.sjbaker.org/humor/cardboard_dog.html) from the original on 5 October 2013, retrieved 9 February 2011.\n4.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-4)** Hayes, David (25 June 2014). ["The Psychology Underlying the Power of Rubber Duck Debugging"](https://web.archive.org/web/20140709011039/http://pressupinc.com/blog/2014/06/psychology-underlying-power-rubber-duck-debugging/). _Press Up via Internet Archive_. Archived from [the original](http://pressupinc.com/blog/2014/06/psychology-underlying-power-rubber-duck-debugging/) on 9 July 2014. Retrieved 10 September 2021.\n5.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-5)** Byrd, Nick; Joseph, Brianna; Gongora, Gabriela; Sirota, Miroslav (2023). ["Tell Us What You Really Think: A Think Aloud Protocol Analysis of the Verbal Cognitive Reflection Test"](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10146599). _Journal of Intelligence_. **11** (4): 76. [doi](https://en.m.wikipedia.org/wiki/Doi_\\(identifier\\)):[10.3390/jintelligence11040076](https://doi.org/10.3390%2Fjintelligence11040076). [PMC](https://en.m.wikipedia.org/wiki/PMC_\\(identifier\\)) [10146599](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10146599). [PMID](https://en.m.wikipedia.org/wiki/PMID_\\(identifier\\)) [37103261](https://pubmed.ncbi.nlm.nih.gov/37103261).\n6.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-6)** [Attwood, Jeff](https://en.m.wikipedia.org/wiki/Jeff_Atwood) (2012). ["Rubber Duck Problem Solving"](https://blog.codinghorror.com/rubber-duck-problem-solving/). _codinghorror.com_. [Archived](https://web.archive.org/web/20220212144738/https://blog.codinghorror.com/rubber-duck-problem-solving/) from the original on 12 February 2022. Retrieved 16 November 2021.\n7.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-7)** [Malan, David](https://en.m.wikipedia.org/wiki/David_J._Malan) (2020). ["Rubber Duck Debugging in CS50 IDE"](https://cs50.noticeable.news/posts/rubber-duck-debugging-in-cs-50-ide). _noticeable.news_.\n8.  **[^](https://en.m.wikipedia.org/wiki/Rubber_duck_debugging#cite_ref-8)** ["Stack Exchange has been taken over by a rubber duck!"](https://meta.stackexchange.com/a/308578). _Meta Stack Exchange_. 31 March 2018. Retrieved 1 April 2018.\n\n [](https://en.m.wikipedia.org/wiki/File:Commons-logo.svg)\n\nWikimedia Commons has media related to [Rubber duck debugging](https://commons.wikimedia.org/wiki/Category:Rubber_duck_debugging).\n\n*   [Rubber Duck Debugging](https://rubberduckdebugging.com/)\n\nRetrieved from "[https://en.wikipedia.org/w/index.php?title=Rubber\\_duck\\_debugging&oldid=1268801328](https://en.wikipedia.org/w/index.php?title=Rubber_duck_debugging&oldid=1268801328)"',
	author: 'Wikipedia Contributors',
	date_published: '2025-01-11T15:45:00.000Z',
	lead_image_url:
		'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Rubber_duck_assisting_with_debugging.jpg/220px-Rubber_duck_assisting_with_debugging.jpg',
