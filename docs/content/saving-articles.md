...
## Save from the web (desktop, recommended)
...
Inboxt works well on mobile as a Progressive Web App. See [Installation](/installation#installing-the-pwa) for how to add it to your home screen.
